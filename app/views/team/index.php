...
<body class="bg-gray-200 ">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between w-full">
                    ...
                    <div class="flex justify-center mt-4">
                        <button type="button"
                            ...
                            onclick="editTeam(<?php echo $team['Id_Team']; ?>)">
                        ...
                        <button type="button"
                            ...
                            onclick="confirmDelete(<?php echo $team['Id_Team']; ?>)">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="updateForm" class="hidden bg-white p-8 rounded w-96 shadow-md max-w-md rounded-2xl">
        ...
        <form method="POST" action="index.php?action=UpdateProject" class="space-y-4">
            <?php if (!empty($projectForUpdate)):
                ...
                <button type="submit"
                    class="w-full text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-yellow-900">Update
                    Project</button>
